...
public class ExpenseController {
        ...
        public ResponseEntity<AppApiResponse<ExpenseResponse>> create(@Valid @RequestBody CreateExpenseDto expense)
                ...
                AppApiResponse<ExpenseResponse> response = AppApiResponse.of(expenseResponse,
        ...
        @DeleteMapping("/{id}")
        @Operation(summary = "Delete an expense", description = "Delete an existing expense by its unique ID.")
        @ApiResponses(value = {
